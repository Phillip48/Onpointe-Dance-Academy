            ...
            <section className="aboutus-holds-everything">
                ...
                <section className="aboutus-staff-holds-photo-div margin-top">
                    ...
                    <div className="aboutus-staff-holds-text">
                        ...
                        <p>Mrs.Danna started dancing at the age of 13. She instantly fell in love with the art of dance which has lead her to dedicate countless hours,studies and, practice to her craft.Mrs.Danna has studied at a professional level with many styles of dance from Ballet all the way to Latin dance.She studied Ballet and Modern dance at the Osceola County School for the Arts  (OSCA) from grades 10 all the way through graduation of high school.Countless time and passion has been dedicated to choreographing and performing for a large number of productions throughout her studies at OSCA.Mrs.Danna has been professionally teaching all levels and a variety of styles for 5+ years. Mrs.Danna is board certified teacher with the state of Florida. Which ensures her teaching styles are up to date with modern learning. She is very excited to share her experience and passion with the students of On Pointe Dance Academy.
                        </p>
                    </div>
                </section>
